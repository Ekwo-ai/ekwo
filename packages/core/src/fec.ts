 ...
 * Livre des procedures fiscales). Produce it from `fec_lines(company, from,
 * to)`; this module turns those rows into the file.
 */

import type { Decimal, IsoDate } from './types.js';
