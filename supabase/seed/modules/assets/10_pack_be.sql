-- Ekwo — Belgium: how this country depreciates and derecognises a fixed asset.
--
-- Generated from packs/be/assets.json at version 1.4.0, do not edit.
...
select v.country::char(2), v.code, v.name, v.name_i18n::jsonb,
  ...
  from (values
    ('BE', 'formation-expenses', 'Frais d''établissement', '{"en":"Formation expenses","nl":"Oprichtingskosten"}'::jsonb, 'straight_line', 60, null, null, 'asset_fixed', 10, 'Code des impôts sur les revenus 1992, art. 62 — les frais d''établissement sont amortis par annuités égales, échelonnées sans interruption sur cinq ans au moins'),
    ('BE', 'intangible-rd', 'Frais de recherche et de développement', '{"en":"Research and development","nl":"Kosten van onderzoek en ontwikkeling"}'::jsonb, 'straight_line', 36, null, null, 'asset_fixed', 20, 'Code des impôts sur les revenus 1992, art. 63 — immobilisations incorporelles amorties par annuités fixes sur trois ans au moins pour les investissements en recherche et développement'),
    ('BE', 'software', 'Logiciels, concessions, brevets et licences', '{"en":"Software, concessions, patents and licences","nl":"Software, concessies, octrooien en licenties"}'::jsonb, 'straight_line', 60, null, null, 'asset_fixed', 30, 'Code des impôts sur les revenus 1992, art. 63 — immobilisations incorporelles autres que la recherche et le développement, amorties par annuités fixes sur cinq ans au moins'),
    ('BE', 'building-industrial', 'Bâtiments industriels', '{"en":"Industrial buildings","nl":"Industriële gebouwen"}'::jsonb, 'straight_line', 240, null, null, 'asset_fixed', 40, 'Code des impôts sur les revenus 1992, art. 61 ; durée usuellement admise par l''administration pour un bâtiment industriel — vingt ans, soit 5 % l''an. Une durée usuelle est une pratique administrative et non un texte : elle se justifie par la dépréciation réelle du bien.'),
    ('BE', 'building-commercial', 'Bâtiments commerciaux et de bureaux', '{"en":"Commercial and office buildings","nl":"Handels- en kantoorgebouwen"}'::jsonb, 'straight_line', 396, null, null, 'asset_fixed', 50, 'Code des impôts sur les revenus 1992, art. 61 ; durée usuellement admise par l''administration pour un bâtiment commercial ou de bureaux — trente-trois ans, soit 3 % l''an. Pratique administrative, à justifier par la dépréciation réelle du bien.'),
    ('BE', 'machinery', 'Installations, machines et outillage', '{"en":"Plant, machinery and equipment","nl":"Installaties, machines en uitrusting"}'::jsonb, 'straight_line', 120, null, null, 'asset_fixed', 60, 'Code des impôts sur les revenus 1992, art. 61 ; durée usuellement admise — dix ans, soit 10 % l''an. Pratique administrative.'),
    ('BE', 'machinery-declining', 'Installations, machines et outillage — régime dégressif', '{"en":"Plant and machinery — declining balance","nl":"Installaties, machines en uitrusting — degressief"}'::jsonb, 'declining_balance', 120, 2, null, 'asset_fixed', 70, 'Code des impôts sur les revenus 1992, art. 64 et AR/CIR 92, art. 36 à 43 — taux double du taux linéaire, annuité plafonnée à 40 % de la valeur d''investissement, retour au linéaire dès qu''il donne une annuité supérieure. Le régime est exclu pour les immobilisations incorporelles et pour les biens dont l''usage est cédé à un tiers (art. 64, al. 2).'),
    ('BE', 'furniture', 'Mobilier', '{"en":"Furniture","nl":"Meubilair"}'::jsonb, 'straight_line', 120, null, null, 'asset_fixed', 80, 'Code des impôts sur les revenus 1992, art. 61 ; durée usuellement admise — dix ans, soit 10 % l''an. Pratique administrative.'),
    ('BE', 'it-equipment', 'Matériel de bureau et matériel informatique', '{"en":"Office and computer equipment","nl":"Kantoor- en informaticamaterieel"}'::jsonb, 'straight_line', 36, null, null, 'asset_fixed', 90, 'Code des impôts sur les revenus 1992, art. 61 ; durée usuellement admise pour le matériel informatique — trois ans, soit 33 % l''an. Pratique administrative.'),
    ('BE', 'vehicle', 'Matériel roulant', '{"en":"Vehicles","nl":"Rollend materieel"}'::jsonb, 'straight_line', 60, null, null, 'asset_fixed', 100, 'Code des impôts sur les revenus 1992, art. 61 ; durée usuellement admise — cinq ans, soit 20 % l''an. Pratique administrative. La déductibilité des frais de voiture est une question distincte de la durée d''amortissement (art. 66 et 198bis).')
