...
--
-- Generated from packs/gb at version 0.3.0, do not edit.
...
values
  ...
  ('GB', 'GB-VAT-RETURN', '6', 'base', 'Total value of sales and all other outputs excluding any VAT', '{}'::jsonb, 60, '{}'::text[], '{}'::text[], false, false, null, 'VAT Notice 700/12, box 6 — the value, excluding VAT, of everything supplied in the period: standard-rated, reduced-rated, zero-rated, exempt and outside the scope of United Kingdom VAT, and exports. The notice also puts the value of a service received from an overseas supplier in this box as well as in box 7, so the tax on that service names both boxes and the amount is printed in each.', 'notice-700-12'),
  ('GB', 'GB-VAT-RETURN', '7', 'base', 'Total value of purchases and all other inputs excluding any VAT', '{}'::jsonb, 70, '{}'::text[], '{}'::text[], false, false, null, 'VAT Notice 700/12, box 7 — the value, excluding VAT, of everything acquired in the period, including imports of goods and the value of a supply on which the customer accounts for the tax under s. 55A. The value of a service received from an overseas supplier is in this box and in box 6 at once, which is one posting naming two boxes rather than two definitions of one figure.', 'notice-700-12'),
