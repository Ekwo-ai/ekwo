...
--
-- Generated from packs/gb at version 0.2.0, do not edit.
...
values
  ...
  ('GB', 'GB-S-20-INC', 'Retail sale, standard rate 20 %, the price includes the VAT', '{}'::jsonb, 'For a price set with the tax already in it, as a retail price is', 'percent', 20, 'sale', 'domestic', date '2011-01-04', null, 'Finance (No. 2) Act 2010, s. 3 for the rate. A retail price in the United Kingdom is quoted with the VAT in it, and VAT Notice 700 gives the fraction that takes it back out — the rate divided by one hundred plus the rate, one sixth at 20 per cent. price_include records that the unit price of a line carrying this tax is the gross price: the engine takes the tax out of the group''s gross and rounds it once, as §§ 17.5 and 17.6 of the notice allow a retailer to do invoice by invoice and as BR-CO-14 requires of a structured invoice.', 'S', null, 50, 'vat', true, null, true, false, null, 'notice-700'),
