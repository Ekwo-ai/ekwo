...
--
-- Generated from packs/ee at version 1.4.0, do not edit.
...
values
  ...
  ('EE', 'EE-KMD', '32', 'base', 'Kauba eksport', '{"en":"Exportation of goods"}'::jsonb, 100, '{}'::text[], '{}'::text[], false, false, null, 'Vorm KMD, lahter 3.2 — käibemaksuseadus § 15 lõike 3 punkt 1. Lahtris 3 deklareeritud summas sisalduv.', 'kmd-vorm'),
  ...
  ('EE', 'EE-KMD', '5', 'tax', 'Kokku sisendkäibemaksu summa, mis on seadusega lubatud maha arvata', '{"en":"Total amount of input VAT subject to deduction pursuant to law"}'::jsonb, 140, '{}'::text[], '{}'::text[], false, false, null, 'Vorm KMD, lahter 5 — käibemaksuseadus §§ 29, 30 ja 31. Lahter kannab juba piirangute järgset summat; Iga mahaarvamine nimetab selle lahtri ise, vajaduse korral koos lahtriga 5.1, 5.2, 5.3 või 5.4.', 'kmd-vorm'),
